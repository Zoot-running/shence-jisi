...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  const priceTable = config.priceTable ?? {
    ...
    // 新官方名 deepseek-flash。v4-pro 保持原价至 2026-09-14 12:00，之后路由至 V4.1-Flash 按 Flash 价。
    ...
    // 2026-09-10 官方公告：pro 句柄路由至 4.1-flash、老 V4-Pro-0813 退役。
    // 定价页 09-11：pro 原价保持至 **09-14 12:00**，之后路由到 V4.1-Flash 按 Flash 价。
    ...
    'glm-5.3': { input: 8, output: 28, cacheRead: 2.3 },      // 官方口径（晚点 2026-08：flash=其 1/10；360 聚合页 7.6/26.6 基本一致）
    'glm-5.3-flash': { input: 0.8, output: 2.8, cacheRead: 0.23 }, // 官方口径（晚点/chinaz 2026-08）
    'glm-4.7': { input: 2, output: 8, cacheRead: 0.2 },       // 360 模型广场聚合页（官方价页未列 4.7+ 世代）
    'glm-4.6': { input: 1, output: 4 },          // ESTIMATE，待智谱价格页核对
    'glm-4.5-air': { input: 0.5, output: 1 },    // ESTIMATE，待智谱价格页核对
  }
